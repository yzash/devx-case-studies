...
interface PeopleSectionProps {
  data: Pick<CaseStudy, 'peopleHeadline' | 'personas' | 'peopleIntro'>
}
  ...
  return (
    <section style={{ background: '#fff' }}>
      <div className="container">
        ...
        <h2 className="section-title" dangerouslySetInnerHTML={{ __html: data.peopleHeadline ?? 'Before we wrote a line of code,<br />we thought about who&apos;d use it.' }} />
